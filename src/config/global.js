export const global = {
  ...
  semanas: 1,
  modalidad: 'Virtual',
  requisitosIngrso: ['No aplica'],
  // imagenBannerPrincipal: require('@/assets/curso/banner-princiapal.svg'),
  videoBannerPrincipal:
    '<iframe data-v-1f9e4816="" width="560" height="315" src="https://www.youtube.com/embed/qm5G74Hvz1E" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="allowfullscreen"></iframe>',
...
export const creditos = {
  ...
  contenidoInstruccional: [
    ...
    },
    {
      ...
      centro: 'Asesores oficina calidad Ministerio de Salud',
    },
    {
